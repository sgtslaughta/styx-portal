...
fetch "$SERVER/api/enroll/engine.py"            -o "$INSTALL_DIR/engine.py"
fetch "$SERVER/api/enroll/gateway.py"           -o "$INSTALL_DIR/gateway.py"
fetch "$SERVER/api/enroll/selkies_launcher.py"  -o "$INSTALL_DIR/selkies_launcher.py"
